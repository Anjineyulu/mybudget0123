...
public class ListRegisterViewDefault extends Composite implements ListRegistersView {
	...
	interface ListRegisterViewDefaultUiBinder extends UiBinder<Widget, ListRegisterViewDefault> {
	}

	public ListRegisterViewDefault() {
